...
export default function Home() {
  ...
  return (
    <div className='bg-white flex-wrap overflow-x-auto overflow-y-auto'>
      ...
      <main className="flex flex-col items-center justify-between px-8 mt-8  bg-white">
          ...
          <div>
            ...
            <div className="mx-auto max-w-2xl  text-center text-dark " style={{ position: 'relative', zIndex: 1 }}>
              ...
              <div className="mt-10 flex items-center justify-center ">
                <a href="#" className="rounded-md bg-purple-rgba px-4 py-3 text-16 font-semibold text-white hover:bg-purple-700">Unlock your card <span aria-hidden="true">→</span></a>
              </div>
